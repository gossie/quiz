...
data class QuizCreatedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
    @JsonProperty("quiz") val quiz: Quiz,
    @JsonProperty("timestamp") override val timestamp: Long = Date().time,
    @JsonProperty("sequenceNumber") override val sequenceNumber: Long = 0
) : Event {
...
data class QuestionEditedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
    @JsonProperty("question") val question: Question,
    @JsonProperty("timestamp") override val timestamp: Long = Date().time,
    @JsonProperty("sequenceNumber") override val sequenceNumber: Long
...
data class QuestionDeletedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
...
data class ParticipantDeletedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
...
data class TimeToAnswerDecreasedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
    @JsonProperty("questionId") val questionId: UUID,
    @JsonProperty("timestamp") override val timestamp: Long = Date().time,
    @JsonProperty("sequenceNumber") override val sequenceNumber: Long
...
data class ChoiceSelectedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
    @JsonProperty("participantId") val participantId: UUID,
...
data class ToggleAnswerRevealAllowedEvent(
    @JsonProperty("quizId") override val quizId: UUID,
    @JsonProperty("participantId") val participantId: UUID,
    @JsonProperty("timestamp") override val timestamp: Long = Date().time,
    @JsonProperty("sequenceNumber") override val sequenceNumber: Long
